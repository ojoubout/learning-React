...
var IndecisionApp = function (_React$Component) {
    ...
    function IndecisionApp(props) {
        ...
        _this.handleSelectDecision = _this.handleSelectDecision.bind(_this);
    ...
    _createClass(IndecisionApp, [{
        ...
        key: 'handleSelectDecision',
        value: function handleSelectDecision() {
            var random = Math.floor(Math.random() * this.state.options.length);
            var decisionOption = this.state.options[random];
...
var Action = function Action(props) {
    return React.createElement(
        ...
        React.createElement(
            'button',
            { disabled: !props.hasOptions, onClick: props.handleSelectDecision },
            'What should i do!'
        )
    );
};
